...
from fermilib.utils._dual_basis_trotter_error import *
from fermilib.utils import Grid, jellium_model, wigner_seitz_length_scale
...
class ErrorBoundTest(unittest.TestCase):
    ...
    def test_error_bound_using_info_2d(self):
        # Generate the Hamiltonian.
        ...
        terms, indices, is_hopping = result
        self.assertAlmostEqual(dual_basis_error_bound(
            terms, indices, is_hopping), 0.052213321121580794)
