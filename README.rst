...
website <http://www.projectq.ch>`__ and the detailed `code documentation <http://fermilib.readthedocs.io/en/latest/fermilib.html>`__. Alternatively, for a quick installation and/or testing, try using a `Docker image <https://github.com/hsim13372/fermiq_docker>`__ that contains FermiLib and ProjectQ. Moreover, take a look at the available `plugins <http://projectq.ch/code-and-docs/#Fermilib>`__ for FermiLib.
